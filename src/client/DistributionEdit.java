...
import org.apache.ws.axis2.MySQLServiceEquipmentStub.Distribution;
...
public class DistributionEdit {
    ...
    public void Add(ActionEvent actionEvent) {
        ...
        dist.setCode(code);
        dist.setCodeCabinet(codeCabinet);
        dist.setCodeEquipment(codeEquipment);
        dist.setNumber(number);
        dist.setDate(date);
